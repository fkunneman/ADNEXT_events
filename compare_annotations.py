...
for i,filename in enumerate(args.a):
    ...
    for line in infile.readlines()[1:]:
        ...
        if assessment == '1' or assessment == '1.0':
            assessment = 1
        else:
            assessment = 0
...
if len(outputA) > 1: #measure interannotator agreement
    ...
    lines = zip([o[1] for o in outputA[0]],[p[1] for p in outputA[1]])
    lfull = zip(outputA[0],outputA[1])
    print(lfull)
#    print(lines)
    mf = calculate_mutual_fscore(lines)
    print(mf)
