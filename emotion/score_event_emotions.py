...
# #    print('middle', event)
    anticipointment1 = event[2] + event[6]
    anticipointment2 = event[3] + event[7]
    anticipointment3 = event[4] + event[8]
    anticifaction1 = event[2] + event[10]
    anticifaction2 = event[3] + event[11]
    anticifaction3 = event[4] + event[12]
    event_scores_complete.append(event + [anticipointment1, anticipointment2, anticipointment3, anticifaction1, anticifaction2, anticifaction3])
        #calculations.calculate_mean_reciprocal_rank([ranks_zin_mean[i], ranks_teleurgesteld_mean[i]])
...
header_style = {'event' : 'general', '#zin' : '0', '0.7 percentile zin' : '0.00', '0.8 percentile zin' : '0.00', 
    '0.9 percentile zin' : '0.00', '#teleurgesteld' : '0', '0.7 percentile teleurgesteld' : '0.00', 
    '0.8 percentile teleurgesteld' : '0.00', '0.9 percentile teleurgesteld' : '0.00', '#tevreden' : '0', 
    '0.7 percentile tevreden' : '0.00', '0.8 percentile tevreden' : '0.00', '0.9 percentile tevreden' : '0.00', 
    'anticipointment 0.7': '0.00', 'anticipointment 0.8' : '0.00', 'anticipointment 0.9' : '0.00',
    'anticifaction 0.7' : '0.00', 'anticifaction 0.8' : '0.00', 'anticifaction 0.9' : '0.00'}
