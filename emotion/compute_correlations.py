...
for jump in jumps:
    for step in steps:
        ...
        try:
            ...
            plt.axis((0, 1, 0, 1))
            plt.ylabel('Proportion of tweets after an event classified as \'Disappointment\'')
            plt.xlabel('Proportion of tweets before an event classified as \'Positive Expectation\'')
            ...
            plt.axis((0, 1, 0, 1))
            plt.ylabel('Proportion of tweets after an event classified as \'Satisfaction\'')
            plt.xlabel('Proportion of tweets before an event classified as \'Positive Expectation\'')
            ...
            plt.axis((0, 1, 0, 1))
            plt.ylabel('Proportion of tweets after an event classified as \'Satisfaction\'')
            plt.xlabel('Proportion of tweets after an event classified as \'Disappointment\'')
