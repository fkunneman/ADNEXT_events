...
headers = ['event', '#zin', '0.5 percentile zin', '0.7 percentile zin', '0.8 percentile zin', '0.9 percentile zin', '#teleurgesteld', 
    ...
    '0.5 percentile tevreden', '0.7 percentile tevreden', '0.8 percentile tevreden', '0.9 percentile tevreden', 'anticipointment 0.7', 'anticipointment 0.8', 
    'anticipointment 0.9', 'anticifaction 0.7', 'anticifaction 0.8', 'anticifaction 0.9', 'anticipointment', 'antisfaction']
header_style = {'event' : 'general', '#zin' : '0', '0.5 percentile zin' : '0.00', '0.7 percentile zin' : '0.00', 
    ...
    '0.8 percentile tevreden' : '0.00', '0.9 percentile tevreden' : '0.00', 'anticipointment 0.7': '0.00', 
    'anticipointment 0.8' : '0.00', 'anticipointment 0.9' : '0.00', 'anticifaction 0.7' : '0.00', 
    'anticifaction 0.8' : '0.00', 'anticifaction 0.9' : '0.00', 'anticipointment' : '0.00', 'antisfaction' : '0.00'}
